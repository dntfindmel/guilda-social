...
public class PerfilService {
  ...
  public PerfilResponseDTO atualizarPerfil(UUID usuarioId, AtualizarPerfilRequestDTO request) {
      ...
      if (request.getDistanciaMaximaKm() != null) {
          usuario.setDistanciaMaximaKm(request.getDistanciaMaximaKm());
      }
  ...
  public PerfilResponseDTO buscarPerfil(UUID usuarioId) {
      ...
      response.setDistanciaMaximaKm(usuario.getDistanciaMaximaKm());  
